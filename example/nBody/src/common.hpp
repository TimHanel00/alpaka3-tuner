...
// softening factor that is added to particle distance to prevent too large
// forces
...
// when a particle is closer to the camera than this, it will not be shown when
// pngs are written
...
// these are only approximate when a normal distribution is used, outliers can
// exist
...
constexpr auto numParticlesBenchmark =
    std::array{512, 1024, 2048, 4096, 8192, 16384, 32768, 65536, 131072};
