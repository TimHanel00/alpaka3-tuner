...
static_cast<std::size_t>(2)>{};
    ...
    {
        constexpr auto tune1 = tune::CTunable<CVec<int, 0, 0>, CVec<int, 3, 3>,
CVec<int, 1, 1>>{}; constexpr auto tune2 = tune::CTunable<CVec<int, 3, 3>,
CVec<int, 6, 6>, CVec<int, 1, 1>>{};
        // static_assert(tune1.tag != tune2.tag, "Compile-time tunables have
duplicate tags!");
        // constexpr auto tune2 = tune::CTunable<CVec<int, 3, 3>, CVec<int, 6,
6>, CVec<int, 1, 1>>{}; return std::tuple{tune1, tune2}; // empty tuple, no
tunables
    }
};*/
...
struct IsKernelArgumentTriviallyCopyable<tune::CTunable<ID, Ts...>>
