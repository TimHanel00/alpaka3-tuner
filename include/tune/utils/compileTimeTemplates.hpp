...
namespace tune::internal::compileTimeHelpers {
...
template <typename KernelFn> struct RegisteredCTuneables {
  using FromTrait =
      tune::trait::CompileTimeTuneableTrait<std::decay_t<KernelFn>>;
...
template <typename KernelFn, tune::concepts::Integral IntType, auto Dim>
inline IntType
