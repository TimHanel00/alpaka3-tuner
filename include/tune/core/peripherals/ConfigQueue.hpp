 ...
 */
#pragma once
#include "tune/config/ConfigRecord.hpp"
#include "tune/utils/StdMTRandomDevice.hpp"

#include <functional>
#include <optional>
#include <queue>

namespace tune::internal::core::peripherals {
...
struct ConfigQueue {
  ...
  static_assert(maxConsecutiveRuns >
                static_cast<uint32_t>(
                    tune::config::ConfigRecord<T_Configs>::warmUpThreshold));
