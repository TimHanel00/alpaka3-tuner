...
namespace tune::internal::store::detail {
...
make_descriptor_json(KernelTuningMetadata const &metaData,
                     KernelTuningModel<ModelArgs...> const &model) {
  nlohmann::json params = nlohmann::json::array();

  // Per-tunable entries including valueHash
  meta::for_each(model.m_allTunables, [&](auto const &elem) {
    params.push_back(
        {{"name", elem.m_name},
...
inline bool same_hard_metadata(nlohmann::json const &nodeMeta,
...
inline nlohmann::json
config_to_json(tune::config::ConfigRecord<T_Config> const &cfg, auto index) {
  nlohmann::json j;
...
inline std::string compute_context_id(nlohmann::json const &metadata,
...
public:
  ...
  read(KernelTuningModel<ModelArgs...> const &model,
       ...
       tune::core::peripherals::EnvironmentState<T_Config> &state) noexcept {
    if (m_filename.empty()) {
