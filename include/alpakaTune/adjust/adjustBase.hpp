...
#include "alpakaTune/utils/partitioning.hpp"
 ...
 * tuner-chosen spaces of numFrames and frameExtent alpakaTune.
 *
...
auto adjustNumFrames(T_DeviceHandle device, T_Exec exec, T_FrameSpecTune &&fs) {
  ...
  if constexpr (FSTM::hasNumBlocksTune()) {
    ...
    auto tune = TunableMD<aTune::frame::numFrames>{
...
auto adjustFrameExtent(T_DeviceHandle device, T_Exec exec,
  ...
  if constexpr (FSTM::hasNumThreadsTune()) {
    ...
    auto tune = TunableMD<aTune::frame::frameExtent>{
